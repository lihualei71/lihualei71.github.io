...
\begin{enumerate}
\item \red{Marandon, A., \textbf{Lei, L.}, Mary, D., and Roquain, R. (2023+) Machine learning meets false discovery rate. \emph{Arxiv e-prints, abs/2208.06685}. Accepted at \emph{Annals of Statistics (AoS)}.}
\item \red{Spector, A., Cand\`{e}s, E. J.*, \textbf{Lei, L.}*, (2023) A Discussion of Tse and Davidson (2022) “A Note on Universal Inference”. To appear in \emph{Stat} (invited discussion paper).}
...
\begin{enumerate}
\item \red{Sahoo, R., \textbf{Lei, L.}, and Wager, S. (2022) Learning from a Biased Sample. \emph{Arxiv e-prints, abs/2209.01754}. Under Reject and Resubmit at \emph{Management Science (MS)}.}
\item \red{Arkhangelsky, D.*, Imbens, G. W.*, \textbf{Lei, L.}*, and Luo, X.* (2021) Double-Robust Two-Way-Fixed-Effects Regression For Panel Data. \emph{Arxiv e-prints, abs/2107.13737}. Resubmitted to \emph{Quantitative Economics (QE)}.}
\item \red{Luo, Y., Fithian, W, and \textbf{Lei, L.} (2022) Improving knockoffs with conditional calibration. \emph{Arxiv e-prints, abs/2208.09542}. Under Reject and Resubmit at \emph{Annals of Statistics (AoS)}.}
\item \red{Angelopoulos, A.*, Bates, S.*, Cand\`{e}s, E. J.*, Jordan, M. I.*, and \textbf{Lei, L.}* (2021) Learn then Test: Calibrating Predictive Algorithms to Achieve Risk Control. Under Major Revision at \emph{Annals of Applied Statistics (AoAS)}.}
\end{enumerate}
...
\begin{enumerate}
\item \red{Viviano, D., \textbf{Lei, L.}, Imbens, G., Karrer, B., Schrijvers, O., and Shi, L. (2023) Causal clustering: design of cluster experiments under network interference. \emph{Arxiv e-prints, abs/2310.14983}. Submitted to \emph{Journal of Political Economy (JPE)}. }
\item \red{Ji, W., \textbf{Lei, L.}, Spector, A. (2023) Model-Agnostic Covariate-Assisted Inference on Partially Identified Causal Effects. \emph{Arxiv e-prints, abs/2310.08115}. }
\item \red{Wang, W., Janson, L., \textbf{Lei, L.}, and Ramdas, A. (2023) Total Variation Floodgate for Variable Importance Inference in Classification. \emph{Arxiv e-prints, abs/2309.04002}. Submitted to \emph{International Conference on Machine Learning (ICML)}.}
\item \red{Andrews, I., Fudenberg, D., \textbf{Lei, L.}, Liang A., and Wu. C. (2023) The Transfer Performance of Economics Models. \emph{Arxiv e-prints, abs/2202.04796}. Submitted to \emph{Journal of Political Economy (JPE)}. }
\item \red{\textbf{Lei, L.}, Sahoo, R., and Wager, S. (2023) Policy Learning under Biased Sample Selection. \emph{Arxiv e-prints, abs/2304.11735}.}
\item \red{\textbf{Lei, L.} and Wooldridge, J. (2022) What Estimators Are Unbiased For Linear Models? \emph{Arxiv e-prints, abs/2212.14185}. Submitted to \emph{Econometric Theory (ET)}.}
\item \red{Angelopoulos, A.*, Bates, S.*, Fisch, A.*, \textbf{Lei, L.}*, and Schuster T.* (2022) Conformal Risk Control. \emph{Arxiv e-prints, abs/2208.02814}. Submitted to \emph{International Conference on Learning Representations (ICLR)}.}
...
\red{Fletcher Jones Faculty Scholar for 2023-24.}
...
\vspace{2mm}
\noindent \textbf{Statistics Journals (60): }(\#papers in parentheses) Annals of Statistics (AoS, 11), Journal of the American Statistical Association (JASA, 10), Biometrika (8), Journal of the Royal Statistical Society-Series B (JRSS-B, 6), Journal of the Royal Statistical Society-Series A (JRSS-A, 1), Bernoulli (2), Electronic Journal of Statistics (EJS, 4), Biometrics (3), Journal of Causal Inference (JCL, 2), Stat (1), Springer Book (1), SpringerBriefs (1), International Journal of Biostatistics (IJB, 1), Journal of Computational and Graphical Statistics (JCGS, 2), Statistica Sinica (1), International Journal of Approximate Reasoning (IJA, 1), Statistics in Biosciences (SIBS, 1), Journal of Statistical Planning and Inference (JSPI, 2), Statistical Science (SS, 2)

\vspace{2mm}
\noindent \textbf{Economics Journals (15): }(\#papers in parentheses) Econometrica (2), Journal of Political Economy (JPE, 4), JPE Mirco (1), The Review of Economics and Statistics (ReStat, 4), Journal of Applied Econometrics (JAE, 1), Journal of Business and Economic Statistics (JBES, 2), Journal of Econometrics (JoE, 1)
...
\begin{itemize}
\item \red{Co-organizer of the Causal Panel Data Conference (with Bryan Graham, Guido Imbens, and Jann Spiess, 2023).}
