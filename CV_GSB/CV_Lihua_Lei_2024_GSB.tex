...
\begin{enumerate}
\item \red{\textbf{Lei, L.}* (2024) Discussion of ”Data Fission: Splitting a Single Data Point” – Some Asymptotic Results for Data Fission. Accepted at \emph{Journal of the American Statistical Association (JASA)} (invited discussion paper).}
\item \red{Arkhangelsky, D., Imbens, G., \textbf{Lei, L.}, and Luo, X. (2024) Design-Robust Two-Way-Fixed-Effects Regression For Panel Data. \emph{Quantitative Economics (QE)}, 15(4), 999-1034.}
...
\begin{enumerate}
\red{\item Wang, W., Janson, L., \textbf{Lei, L.}, and Ramdas, A. (2024) Total Variation Floodgate for Variable Importance Inference in Classification. In \emph{Proceedings of the 41th International Conference on Machine Learning (ICML)}.}
\red{\item Angelopoulos, A.*, Bates, S.*, Fisch, A.*, \textbf{Lei, L.}*, and Schuster T.* (2023) Conformal Risk Control. In \emph{International Conference on Learning Representations (ICLR)}.}
...
\begin{enumerate}
\item \red{\textbf{Lei, L.}* and Ross, B.* (2023) Estimating Counterfactual Matrix Means with Short Panel Data. \emph{Arxiv e-prints, abs/2312.07520}. Under Reject and Resubmit at \emph{Econometrica}.}
...
\item \red{Luo, Y., Fithian, W, and \textbf{Lei, L.} (2022) Improving knockoffs with conditional calibration. \emph{Arxiv e-prints, abs/2208.09542}. Under 2nd-round Major Revision at \emph{Annals of Statistics (AoS)}.}
\item \red{Angelopoulos, A.*, Bates, S.*, Cand\`{e}s, E. J.*, Jordan, M. I.*, and \textbf{Lei, L.}* (2021) Learn then Test: Calibrating Predictive Algorithms to Achieve Risk Control. Under Minor Revision at \emph{Annals of Applied Statistics (AoAS)}.}
\end{enumerate}
...
\begin{enumerate}
\item \red{Luo, Y., Fithian, W. and \textbf{Lei, L.} (2024) Estimating the FDR of variable selection. \emph{Arxiv e-prints, abs/2408.07231}. Submitted to \emph{Annals of Statistics (AoS)}.}
\item \red{Ji, W.*, \textbf{Lei, L.}*, and Spector A. (2023) Model-Agnostic Covariate-Assisted Inference on Partially Identified Causal Effects. \emph{Arxiv e-prints, abs/2310.08115}. Submitted to \emph{Journal of Political Economy (JPE)}.}
\item \red{Andrews, I., Fudenberg, D., \textbf{Lei, L.}, Liang A., and Wu. C. (2023) The Transfer Performance of Economics Models. \emph{Arxiv e-prints, abs/2202.04796}. Submitted to \emph{American Economic Review (AER)}.}
\end{enumerate}
...
\end{large}
\begin{enumerate}
\item \red{\textbf{Lei, L.} (2024) Causal Interpretation of Regressions With Ranks. \emph{Arxiv e-prints, abs/2406.05548}.}
\item \red{Yang, Z., \textbf{Lei, L.}, and Cand\`{e}s, E. J. (2024) Bellman Conformal Inference: Calibrating Prediction Intervals For Time Series. \emph{Arxiv e-prints, abs/2402.05203}.}
\item \red{\textbf{Lei, L.}* and Sudijono, T.* (2024) Inference for Synthetic Controls via Refined Placebo Tests. \emph{Arxiv e-prints, abs/2401.07152}.}
...
\begin{enumerate}
\item \red{OIT 274 Data \& Decisions (Base, Winter 2024)}
\item \red{MGTECON 614 Emerging Topics in Econometrics (Fall 2024): a new PhD topic course in econometrics. }
\end{enumerate}
...
\red{Bernoulli Society New Reseacher Award, 2025.}

\vspace{2mm}

\red{NSF CAREER award, 2024.}
...
\vspace{2mm}
\noindent \textbf{Statistics Journals (73): }(\#papers in parentheses) Annals of Statistics (AoS, 17), Journal of the American Statistical Association (JASA, 10), Biometrika (10), Journal of the Royal Statistical Society-Series B (JRSS-B, 9), Journal of the Royal Statistical Society-Series A (JRSS-A, 1), Bernoulli (2), Electronic Journal of Statistics (EJS, 4), Biometrics (3), Journal of Causal Inference (JCL, 2), Stat (1), Springer Book (1), SpringerBriefs (1), International Journal of Biostatistics (IJB, 1), Journal of Computational and Graphical Statistics (JCGS, 2), Statistica Sinica (3), International Journal of Approximate Reasoning (IJA, 1), Statistics in Biosciences (SIBS, 1), Journal of Statistical Planning and Inference (JSPI, 2), Statistical Science (SS, 2), Statistics (1)

\vspace{2mm}
\noindent \textbf{Economics Journals (20): }(\#papers in parentheses) Econometrica (3), Journal of Political Economy (JPE, 4), Review of Economic Studies (ReStud, 1), JPE Mirco (2), The Review of Economics and Statistics (ReStat, 5), Journal of Applied Econometrics (JAE, 1), Journal of Business and Economic Statistics (JBES, 2), Journal of Econometrics (JoE, 2)
