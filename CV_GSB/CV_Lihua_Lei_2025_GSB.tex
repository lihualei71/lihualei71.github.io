...
\begin{enumerate}
\item {\color{red}Luo, Y., Fithian, W, and \textbf{Lei, L.} (2025) Improving knockoffs with conditional calibration. \emph{Arxiv e-prints, abs/2208.09542}. Accepted at \emph{Annals of Statistics (AoS)}.}  
...
\begin{enumerate}
\item {\color{red}Li, X., Li, Y., Zhong, H., \textbf{Lei, L.} and Deng, Z. (2025). Statistical Inference under Performativity. In \emph{Annual Conference on Neural Information Processing Systems (NeurIPS)}}.
\item {\color{red}Chen, C., Shen, J., Deng, Z., \textbf{Lei, L.} (2025) Conformal Tail Risk Control for Large Language Model Alignment. In \emph{Proceedings of the 42th International Conference on Machine Learning (ICML)}}.
...
\begin{enumerate}
\item \textbf{Lei, L.}* and Ross, B.* (2023) Estimating Counterfactual Matrix Means with Short Panel Data. \emph{Arxiv e-prints, abs/2312.07520}. Under Reject and Resubmit at \emph{\textbf{Econometrica}}.
\item {\color{red}Ji, W.*, \textbf{Lei, L.}*, and Spector A.* (2023) Model-Agnostic Covariate-Assisted Inference on Partially Identified Causal Effects. \emph{Arxiv e-prints, abs/2310.08115}. Under Major Revision at \emph{\textbf{Journal of Political Economy (JPE)}}.}
\item Sahoo, R., \textbf{Lei, L.}, and Wager, S. (2022) Learning from a Biased Sample. \emph{Arxiv e-prints, abs/2209.01754}. {\color{red}Under Minor Revision at \emph{Management Science (MS)}}.  
\item {\color{red}Ji, W.*, \textbf{Lei, L.}*, and Zrnic, T.* (2025) Predictions as surrogates: Revisiting surrogate outcomes in the age of AI. \emph{ArXiv preprint abs/2501.09731}. Under Major Revision at \emph{Biometrika}.}
\item {\color{red}Hartog, W.*, \textbf{Lei, L.}* (2025) Family-wise error rate control with e-values. \emph{ArXiv preprint abs/2501.09015}. Under Major Revision at \emph{Annals of Statistics (AoS)}.}
\item {\color{red}Luo, Y., Fithian, W. and \textbf{Lei, L.} (2024) Estimating the FDR of variable selection. \emph{Arxiv e-prints, abs/2408.07231}. Under Major Revision at \emph{Annals of Statistics (AoS)}}.
\end{enumerate}
...
\begin{enumerate}
\item \textbf{Lei, L.}* and Sudijono, T.* (2024) Inference for Synthetic Controls via Refined Placebo Tests. \emph{Arxiv e-prints, abs/2401.07152}. To be submitted to \textbf{\textbf{Review of Economic Studies}} in December, 2025 after a conference talk
\item Viviano, D., \textbf{Lei, L.}, Imbens, G., Karrer, B., Schrijvers, O., and Shi, L. (2023) Causal clustering: design of cluster experiments under network interference. \emph{Arxiv e-prints, abs/2310.14983}. Under Review at \emph{Journal of the American Statistical Association (JASA)}
\end{enumerate}
}

\begin{large}
\noindent Preprints (available on ArXiv)
\end{large}

\begin{enumerate}
\item {\color{red}Chen, J.*, \textbf{Lei, L.}*, Sudijono, T*., Sun, L.*, and Xie, T*. (2025) Compound Selection Decisions: An Almost SURE Approach. \emph{Arxiv e-prints, abs/2511.11862}}
\item {\color{red}Ji, W., Pan, Y., Zhu, R. and \textbf{Lei, L.} (2025) Multi-Armed Bandits With Machine Learning-Generated Surrogate Rewards. \emph{Arxiv e-prints, abs/2506.16658}.}
...
\item Andrews, I., Fudenberg, D., \textbf{Lei, L.}, Liang A., and Wu. C. (2023) The Transfer Performance of Economics Models. \emph{Arxiv e-prints, abs/2202.04796}. {\color{red}(Accepted at EC 2025)}.
...
{\color{red}
\begin{large}
\noindent Work in Progress (to be finished in one year\footnote{These projects started from 2023-2025 -- I did not know I need to add work in progress in the CV in the past.})
\end{large}

\begin{enumerate}
\item Supply Shocks Can Identify Price Counterfactuals in Nonparametric Demand Models (w/ Kirill Borusyak, Jiafeng Chen, and Peter Hull).
\item Regression Discontinuity Aggregation, with an Application to the Union Effects on Inequality (w/ Kirill
  Borusyak and Matan Kolerman-Shemer).
\item Inflation Forecasting with micro data (w/ Catherine Chen, Chen Gao, Chen Lian, and Jonathan Hazell).
\item Modern Omitted Variable Bias (w/ Isaac Sorkin).
\item Inference With Misaligned Subjective Expectations (w/ Alexandru Lopotenco and Christopher Tonetti).
\item Many Hands Make Light Work: Long-Term Effect Inference for the Experiment Reservoir (w/ William Hartog, Navdeep Sahni, and DoorDash collaborators)
\item Advertising effects: validation of pre-post analysis (w/ Jessica Nguyen, Navdeep Sahni, and DoorDash collaborators)
\item Robust Decision Making under a Latent Choice Model (w/ Roshni Sahoo and Stefan Wager)
\item Wrong but better: When pretrained models win in AI-assisted inference (w/ Ginnie Ma and Jann Spiess)
\item Compound Estimation for Binomials (w/ Yan Chen)  
\end{enumerate}
}
...
\begin{enumerate}
\item OIT 274: Data and Decisions - Base, Winter 2024, {\color{red}2025}
\item {\color{red}MGTECON 614: Emerging Topics in Econometrics, Fall 2024 (second-year econometrics topic class)}
\end{enumerate}
...
{\color{red}ICSA Outstanding Young Reseacher Award, 2025.}

\vspace{2mm}

{\color{red}Bernoulli Society New Reseacher Award, 2025.}
...
\item Invited mentor and panelist at ``Rising Stars in Data Science Workshop'' (2025)
\end{itemize}
