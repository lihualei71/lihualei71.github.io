...
\begin{enumerate}
\item Sahoo, R., \textbf{Lei, L.}, and Wager, S. (2022) Learning from a Biased Sample. \emph{Arxiv e-prints, abs/2209.01754}. Accepted at \emph{Management Science (MS)}.  
\item Luo, Y., Fithian, W. and \textbf{Lei, L.} (2026) Estimating the FDR of variable selection. \emph{Arxiv e-prints, abs/2408.07231}. Accepted at \emph{Annals of Statistics (AoS)}.    
\item Luo, Y., Fithian, W, and \textbf{Lei, L.} (2025) Improving knockoffs with conditional calibration. \emph{Arxiv e-prints, abs/2208.09542}. Accepted at \emph{Annals of Statistics (AoS)}.  
...
\begin{enumerate} 
\item Chen, Y.*, \textbf{Lei, L.} (2026) Compound Estimation for Binomials. Accepted at \emph{The 27th ACM Conference on Economics and Computation (EC)}.
\item Chen, C., Shen, J., Deng, Z., \textbf{Lei, L.} (2026) Adversarially Robust Control of Conditional Value-at-Risk via Kelly Conformal Inference. Accepted at \emph{The 43rd International Conference on Machine Learning (ICML)}.
...
\item Andrews, I., Fudenberg, D., \textbf{Lei, L.}, Liang A., and Wu. C. (2023) The Transfer Performance of Economics Models. Accepted at \emph{The 26th ACM Conference on Economics and Computation (EC)}.
...
\begin{enumerate}
\item \textbf{Lei, L.}* and Ross, B.* (2023) Estimating Counterfactual Matrix Means with Short Panel Data. \emph{Arxiv e-prints, abs/2312.07520}. Under Revise and Resubmit at \emph{Econometrica}.
...
\begin{enumerate}
\item \textbf{Lei, L.*} (2026) How Much Can Gaussian Dependence Inflate the Benjamini–Hochberg Procedure’s FDR? \emph{ArXiv e-prints abs/2607.14812}.
\item Chen, C.*, Gao, C.*, Hazell, J.*, \textbf{Lei, L.*}, and Lian, C.* (2026). Forecasting Inflation with Microdata: An Adaptive Machine Learning Approach. \emph{ArXiv e-prints abs/2607.12345}.
\item Sudijono, T., \textbf{Lei, L.}, Masoero, L., Vijaykumar, S., Imbens, G., and McQueen, J. (2026). Regression Adjustments for Double Randomization in Two-Sided Marketplaces. \emph{ArXiv e-prints, abs/2603.19480}.
\item Tan, L., Sagan, N., \textbf{Lei, L.}, and Blanchet, J. (2026). When Should Humans Step In? Optimal Human Dispatching in AI-Assisted Decisions. \emph{ArXiv e-prints, abs/2603.13688}.
\item Borusyak, K.*, Chen, J.*, Hull, P.*, \textbf{Lei, L.}* (2025) Nonparametric Identification of Demand without Exogenous Product Characteristics. \emph{Arxiv e-prints, abs/2512.23211}.
...
\vspace{4mm}
\noindent 2026: Cornell (Econ), UCSD (Econ), Stanford (Stats), Cowles Foundation Summer Conference in Econometrics (Yale), NBER Summer Institute (Forecasting \& Empirical Methods), Joint Statistical Meetings (JSM), EcoSta Conference, Southern Economic Association (SEA) Annual Meeting. 
...
\vspace{2mm}
\noindent \textbf{Conferences: }(year in parentheses) ICML (2019, 2020, 2021, 2026), NeurlPS (2019, 2020, 2021), COLT (2019, 2020, 2021), AISTATS (2019), UAI (2020, 2021)
