...
\begin{enumerate}
\item Angelopoulos, A.*, Bates, S.*, Cand\`{e}s, E. J.*, Jordan, M. I.*, and \textbf{Lei, L.}* (2025) Learn then Test: Calibrating Predictive Algorithms to Achieve Risk Control. Accepted at \emph{Annals of Applied Statistics (AoAS)}.
\item \textbf{Lei, L.}* (2024) Discussion of ”Data Fission: Splitting a Single Data Point” – Some Asymptotic Results for Data Fission. Accepted at \emph{Journal of the American Statistical Association (JASA)} (invited discussion paper).
...
\item Ji, W.*, \textbf{Lei, L.}*, and Spector A. (2023) Model-Agnostic Covariate-Assisted Inference on Partially Identified Causal Effects. \emph{Arxiv e-prints, abs/2310.08115}.
