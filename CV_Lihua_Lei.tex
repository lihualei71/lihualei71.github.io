...
\begin{enumerate}
\item Arkhangelsky, D.*, Imbens, G. W.*, \textbf{Lei, L.}*, and Luo, X.* (2021) Double-Robust Two-Way-Fixed-Effects Regression For Panel Data. \emph{Arxiv e-prints, abs/2107.13737}. Accepted at \emph{Quantitative Economics (QE)}.
\item Marandon, A., \textbf{Lei, L.}, Mary, D., and Roquain, R. (203) Machine learning meets false discovery rate. \emph{Arxiv e-prints, abs/2208.06685}. Accepted at \emph{Annals of Statistics (AoS)}.
...
\item Angelopoulos, A.*, Bates, S.*, Cand\`{e}s, E. J.*, Jordan, M. I.*, and \textbf{Lei, L.}* (2021) Learn then Test: Calibrating Predictive Algorithms to Achieve Risk Control. Under Major Revision at \emph{Annals of Applied Statistics (AoAS)}.
\end{enumerate}
...
\begin{enumerate}
\item Luo, Y., Fithian, W. and \textbf{Lei, L.} (2024) Estimating the FDR of variable selection. \emph{Arxiv e-prints, abs/2408.07231}.
...
\item \textbf{Lei, L.}* and Ross, B.* (2023) Estimating Counterfactual Matrix Means with Short Panel Data. \emph{Arxiv e-prints, abs/2312.07520}.
