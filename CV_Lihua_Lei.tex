...
\begin{enumerate}
\item Marandon, A., \textbf{Lei, L.}, Mary, D., and Roquain, R. (2023+) Machine learning meets false discovery rate. \emph{Arxiv e-prints, abs/2208.06685}. Accepted at \emph{Annals of Statistics (AoS)}.
...
\begin{enumerate}
\item Angelopoulos, A.*, Bates, S.*, Fisch, A.*, \textbf{Lei, L.}*, and Schuster T.* (2022) Conformal Risk Control. In \emph{International Conference on Learning Representations (ICLR)}.
